...
var RadPieChart = (function (_super) {
    ...
    RadPieChart.prototype.onSeriesSelectionModeChanged = function (data) {
        ...
        if (data.newValue) {
            ...
            else if (commonModule.ChartSelectionMode.None === data.newValue) {
...
var DonutSeries = (function (_super) {
    ...
    DonutSeries.prototype.updateOwnerChart = function () {
        if (this.owner && (this.owner instanceof RadPieChart)) {
...
var RadCartesianChart = (function (_super) {
    ...
    RadCartesianChart.prototype.SeriesCollectionChangedInternal = function (data) {
        ...
        for (var i = 0; i < this.series.length; ++i) {
            ...
            if (curSeries instanceof BarSeries || curSeries instanceof RangeBarSeries) {
    ...
    RadCartesianChart.prototype.onHorizontalAxisChanged = function (data) {
        ...
        if (this.series && this.series.length > 0) {
            for (var i = 0; i < this.series.length; ++i) {
                if (this.series.getItem(i) instanceof BarSeries || this.series.getItem(i) instanceof RangeBarSeries) {
    ...
    RadCartesianChart.prototype.onSelectionModeChanged = function (data) {
        ...
        if (data.newValue) {
            ...
            if (commonModule.ChartSelectionMode.Single.toLowerCase() === newVal) {
                this.ios.selectionMode = TKChartSelectionMode.TKChartSelectionModeSingle;
            }
            else if (commonModule.ChartSelectionMode.Multiple.toLowerCase() === newVal) {
                this.ios.selectionMode = TKChartSelectionMode.TKChartSelectionModeMultiple;
            }
        }
    };
    RadCartesianChart.prototype.onSeriesSelectionModeChanged = function (data) {
        ...
        if (data.newValue) {
            switch (data.newValue.toLowerCase()) {
                case commonModule.ChartSelectionMode.Single.toLowerCase():
                    this.ios.seriesSelectionMode = TKChartSelectionMode.TKChartSelectionModeSingle;
                    break;
                case commonModule.ChartSelectionMode.Multiple.toLowerCase():
                    this.ios.seriesSelectionMode = TKChartSelectionMode.TKChartSelectionModeMultiple;
                    break;
                case commonModule.ChartSelectionMode.None.toLowerCase():
                    this.ios.seriesSelectionMode = TKChartSelectionMode.TKChartSelectionModeNone;
                    break;
            }
        }
...
var RadLegendView = (function (_super) {
    ...
    RadLegendView.prototype.updateLegendPosition = function (chartView) {
        ...
        if (this.position.toLowerCase() === commonModule.ChartLegendPosition.Floating.toLowerCase()) {
...
var ChartGridLineAnnotation = (function (_super) {
    ...
    ChartGridLineAnnotation.prototype.onZPositionChanged = function (data) {
        if (data.newValue) {
            switch (data.newValue.toLowerCase()) {
                case commonModule.ChartAnnotationZPosition.BelowSeries.toLowerCase():
